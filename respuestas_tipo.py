RESPUESTAS_TIPO = {
    "camarero": {
        "¿Dónde vives actualmente y cómo sueles desplazarte al trabajo? En caso de utilizar transporte público, ¿cómo te organizas si sales del local después del último servicio (por ejemplo, fuera del horario del metro)?": [
            "Vivo cerca del trabajo y siempre voy caminando. Si algún día salgo tarde o hay algún problema, tengo alternativas como bici o patinete eléctrico.",
            "Vivo a 20 minutos en metro, pero si salgo tarde suelo usar Cabify o me coordino con compañeros para compartir coche.",
            "Uso transporte público normalmente. Si salgo fuera de horario, suelo esperar el primer metro o llamar a un familiar.",
            "Dependo del metro. Si no hay servicio, tengo que ver cómo me organizo en el momento.",
            "No lo había pensado. Creo que si no hay metro tendría que caminar o esperar."
        ],
        "¿Tienes disponibilidad para trabajar por la noche y los fines de semana? ¿Podrías desplazarte sin problema a cualquiera de nuestros locales en esos horarios?": [
            "Sí, total disponibilidad para noches y fines de semana. Me puedo mover sin problema a cualquiera de los locales.",
            "En general sí, salvo alguna excepción puntual. Tengo vehículo propio.",
            "Sí, pero preferiría evitar turnos dobles seguidos. Dependo de transporte público.",
            "Depende del día. Algunas noches no podría. Vivo lejos de algunos locales.",
            "Preferiría solo de día. Las noches me resultan complicadas por transporte y familia."
        ],
        "¿Qué idiomas hablas y cuál es tu nivel en cada uno de ellos? Puedes mencionar si tienes fluidez al hablar, escribir o entender, y si los utilizas habitualmente en el trabajo.": [
            "Hablo español e inglés con fluidez, y entiendo algo de francés. Uso el inglés cada día en mi trabajo.",
            "Español nativo y nivel medio de inglés. Puedo atender mesas en inglés sin problema.",
            "Inglés básico. Lo entiendo más que hablarlo. No lo uso mucho.",
            "Solo español. No hablo otros idiomas.",
            "Nunca he estudiado idiomas. Solo español."
        ],
        "¿Qué es lo que más te gustaba y lo que menos de tu último trabajo? ¿Por qué motivo decidiste dejarlo?": [
            "Me encantaba el trato con los clientes y el equipo. Lo dejé por una oportunidad de crecimiento que al final no se concretó.",
            "Disfrutaba el ambiente. Lo que menos, los turnos desorganizados. Cambié por mejores condiciones.",
            "No estaba mal, pero no sentía que aprendiera nada nuevo. Lo dejé por aburrimiento.",
            "El trabajo era muy exigente y no me sentía valorado. Lo dejé por estrés.",
            "Me fui porque no me gustaba nada. No me entendía con nadie."
        ],
        "¿Cómo describirías el ambiente de trabajo en tus empleos anteriores? ¿Qué tal era tu relación con los compañeros y el equipo?": [
            "Muy buena. Siempre he trabajado en equipos donde nos apoyábamos mutuamente y había buena comunicación.",
            "En general buena. A veces había tensión, pero lo normal en hostelería.",
            "Regular. Algunos compañeros eran difíciles, pero yo me adaptaba.",
        ...
        "Estás atendiendo cuatro mesas que han llegado con poco margen entre ellas. ¿Cómo decides a cuál atender primero?": [
            ...
            "Comienzo con la mesa más numerosa, ya que suelen tardar más en decidir, y así aprovecho para seguir avanzando con las otras.",
            "Sigo el orden FIFO (First In, First Out), atendiendo estrictamente según el orden de llegada para mantener imparcialidad."
        ],
